 ...
 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="card col-8" style="padding:15px; ">
     ...
     <div class="row">
        ...
        <div class="col-xs-4 col-sm-4 col-md-4">
            <div class="form-group">
                ...
                <input type="date" name="start_date" class="form-control" placeholder="Faculty">
            </div>
            </div>
        </div>
        <div class="row">
        <div class="col-xs-6 col-sm-6 col-md-6">
            <div class="form-group">
                ...
                <input type="date" name="end_date" class="form-control" placeholder="Faculty">
            </div>
            </div>
        </div>
