 ...
 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
   ...
   <div class="form-group row mb-0">
    ...
    <div class="row">
     ...
     <strong class="col-md-1 text-md-right"></strong>
           <img src="{{asset('images/'.$user->avatar)}}"style="width:190px;height:170px; float:left; border-radius:50%; margin-top:20px">
   ...
   <br>
    ...
    <div class="row" style="color:rgb(175, 174, 179);" >
     <strong class="col-md-2 text-md-right">About Me:</strong>
           <p style="border:1px solid rgba(0, 0, 0, 0.1);padding:0 10px;">{{  $user->About_user }}</p>
    </div>
